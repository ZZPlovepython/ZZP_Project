        ...
        while True:
            ...
            for i in range(len(listread) // 4):
                try:
                    ...
                    sqlString = ("INSERT INTO `newdata`(`Timestamp`, `WeightTag1`, `WeightTag2`, `WeightTag3`, `WeightTag4`) VALUES ('%s', %f, %f, %f, %f)" % (now, listread[4 * (i - 1)], listread[4 * (i - 1) + 1], listread[4 * (i - 1) + 2], listread[4 * (i - 1) + 3]))
